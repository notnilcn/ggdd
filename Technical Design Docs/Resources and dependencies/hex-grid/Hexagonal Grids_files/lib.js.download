        ...
        static testOffsetToDoubled() {
            for (var col = -2; col < 3; col++) {
                for (var row = -2; row < 3; row++) {
                    ...
                    var qdoubled = new DoubledCoord(col * 2 + (row & 1), row);
                    ...
                    var rdoubled = new DoubledCoord(col, row * 2 + (col & 1));
