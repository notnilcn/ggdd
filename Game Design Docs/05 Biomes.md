...
It'd be cool if you made the biome chunks reference a static world for each biome. As in, each biome has its own stored biome world and when a certain chunk changes to that biome world it persists.
